...
class IdealSBSSequencing(Step):
    ...
    def process(self, pool: datastructures.SeqPool,simu_path):
    ...
    def _sequence(self, seqpool: datastructures.SeqPool,simu_path):
        ...
        cluster_seqpool.save_as_fasta(simu_path+"dt4dds_syn.fasta")
