...
def normal_encode(bit_segments,max_homopolymer,max_content):
    dna_sequences = []
    bad_data = []
...
def yinyangencode(bit_segments,max_homopolymer,max_content):
    bit_segments = [[int(bit) for bit in bit_seq] for bit_seq in bit_segments]
    # return faster_encode(bit_segments,max_homopolymer)
    return normal_encode(bit_segments,max_homopolymer,max_content)
