...
if __name__ == "__main__":
    ...
    # way, segments_path,outfilepath,strandlen,coderatecode,max_hpoly_run,npackets  = 'encode','bit_segments.txt','bit_segments_decode.fasta',260,1,4,4
    ...
    # way, segments_path,outfilepath,strandlen,coderatecode,max_hpoly_run,npackets  = 'decode','22_hedges.fasta.0123.txt','22_hedges_decode.txt',260,1,4,4
